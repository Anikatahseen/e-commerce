                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                <ins><span class="text-brand">${{$product->reqular_price}}</span></ins>
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                <button type="button" class="button button-add-to-cart" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->reqular_price}})">Add to cart</button>
                                                ...
                                                <div class="product-cart-wrap small hover-up">
                                                    ...
                                                    <div class="product-content-wrap">
                                                        ...
                                                        <div class="product-price">
                                                            <span>${{$rproduct->reqular_price}}</span>
